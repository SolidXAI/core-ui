...
export function getSolidRoutes(options: SolidRoutesOptions = {}): RouteObject[] {
  ...
  const adminChildren: RouteObject[] = [
    ...
    { path: "/admin/core/:moduleName/workflow-definition/editor/:id", element: <WorkflowDefinitionEditorPage />, handle: { title: "Workflow Definition Editor", manageDocumentMeta: true } },
