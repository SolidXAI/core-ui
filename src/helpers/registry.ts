...
export const registerExtensionComponent = (name: string, component: React.ComponentType<any>, type: ExtensionComponentType = ExtensionComponentTypes.form_field_view_widget, aliases: string[] = [], fieldType: string = '') => {
