export const ERROR_MESSAGES = {
  ...
  SAVED_FILTER_CREATED_SUCCESSFULLY: 'Saved filter created successfully!',
  SAVED_FILTER_UPDATED: 'Saved filter updated',
  SAVED_FILTER_UPDATED_SUCCESSFULLY: 'Saved filter updated successfully!',
