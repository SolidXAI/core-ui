                ...
                <div className="w-full" style={{ zIndex: 1 }}>
                    <div className="grid">
                        <div className="col-8 mx-auto">
                            {appSubtitle && <h1 className="solid-auth-image-subtitle m-0">{solidSettingsData?.data?.appSubtitle}</h1>}
                            {appTitle && <h1 className="solid-auth-image-title mt-0">{solidSettingsData?.data?.appTitle}</h1>}
                            {appDescription && <p className="solid-auth-image-helper-text">{solidSettingsData?.data?.appDescription}</p>}
                        </div>
                    </div>
                </div>
            }
                    ...
                    {renderBrand("center")}
                        {showAuthContent &&
                            <div className="solid-auth-center-details">
                                ...
                                {/* {appTitle ? <h1 className="solid-auth-center-title">{appTitle}</h1> : null} */}
                                {appDescription ? <p className="solid-auth-center-description">{appDescription}</p> : null}
                            </div>
                        }
                        {authChildren}
                    </div>
