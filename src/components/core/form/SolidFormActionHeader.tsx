                            ...
                            <div className="flex items-center solid-header-buttons-wrapper solid-form-toolbar-actions">
                                ...
                                {params.embeded == true &&
                                    <>
                                        <div className="hidden lg:flex">
                                            <div>
                                                <SolidButton variant="outline" size="sm" type="button" label="Close" onClick={() => params.handlePopupClose()} className='solid-bg-primary-reverse' style={{ minWidth: 66 }} />
                                            </div>
                                        </div>
                                        <div className="lg:hidden">
                                            <SolidButton variant="outline" size="sm" type="button" icon="si si-times" onClick={() => params.handlePopupClose()} className='solid-bg-primary-reverse solid-icon-button' />
                                        </div>
                                    </>
                                }
                                {/* {params.embeded !== true &&
