            ...
            <div className="solid-form-wrapper" ref={solidFormWrapperRef}>
                <div className="solid-form-section">
                    <form style={{ width: '100%' }} onSubmit={formik.handleSubmit}>
                        ...
                        />
                        <div className={`px-3 py-3 md:p-4 solid-form-content md:pt-1 ${createMode ? 'solid-create-mode-form-content' : 'solid-edit-mode-form-content'} ${params.embeded === true ? 'h-auto' : ''}`} style={{ maxHeight: params.embeded === true ? '80vh' : '', overflowY: 'auto' }}>
