                    ...
                    <div className="flex items-center md:gap-2">
                        ...
                        <div className="w-full flex flex-col gap-1">
                                <div className="flex items-center justify-between">
                                    <p className="font-normal w-3/4 text-primary m-0 solid-img-text-wrapper" style={{ cursor: 'pointer' }} onClick={() => handleFileView(fileDetails[0])}>{fileDetails[0].name}</p>
                        ...
                        return (
                            <div key={fileId} className="solid-file-upload-wrapper">
                                <div className="flex items-center md:gap-2">
                                    ...
                                    <div className="w-full flex flex-col gap-1">
                                        <div className="flex items-center justify-between">
                                            <p className="font-normal w-[91.666667%] text-primary m-0 solid-img-text-wrapper" style={{ cursor: 'pointer' }} onClick={() => handleFileView(file)}>{file.name}</p>
                                            <div className="flex items-center gap-2">
                                                <button
                                                    type="button"
                                                    className="solid-file-icon-btn"
            ...
            {fileDetails.length > 0 &&
                <div className="solid-file-view-wrapper">
                    <div className="flex items-center md:gap-2">
                        ...
                        <div className="w-full flex flex-col gap-1">
                            <div className="flex items-center justify-between">
                                <p className="font-normal w-[91.666667%] text-primary m-0 solid-img-text-wrapper" style={{ cursor: 'pointer' }} onClick={() => handleFileView(fileDetails[0])}>{fileDetails[0].name}</p>
                                <div className="flex items-center md:gap-2">
                    <div>
                        <SolidButton
                            type="button"
                        ...
                        return (
                            <div key={fileId} className="solid-file-view-wrapper">
                                <div className="flex items-center md:gap-2">
                                    ...
                                    <div className="w-full flex flex-col gap-1">
                                        <div className="flex items-center justify-between">
                                            <p className="font-normal w-[91.666667%] solid-img-text-wrapper" style={{ cursor: 'pointer' }} onClick={() => handleFileView(file)}>{file.name}</p>
                                            <div className="flex items-center md:gap-2">
                                                <div>
                                                    <SolidButton
                                                        type="button"
