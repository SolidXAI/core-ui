    ...
    const handlePopupOpen = (id: any) => {
        if (lastPathSegment === "new") {
            ...
            const formviewparams = {
                ...
                parentData: userKeyField ? { [userKeyField]: { solidManyToOneLabel: fieldContext.data[userKeyField], solidManyToOneValue: fieldContext.data['id'] }, modelName: fieldContext.modelName } : {}
            }
