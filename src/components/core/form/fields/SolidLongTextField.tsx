...
export const DynamicJsonEditorFormViewWidget = ({ formik, fieldContext }: SolidFormFieldWidgetProps) => {
    ...
    return (
        <div className="mt-6">
            ...
            <div className="p-4 rounded surface-card shadow-sm">
                ...
                <div className="flex flex-col gap-2">
                    {
                        ...
                        data.map((row, idx) => (
                            <div
                                key={idx}
                                className={`flex ${fieldLayoutInfo.attrs?.className ? `flex-${fieldLayoutInfo.attrs?.className}`: 'flex-row'} border rounded p-3 gap-2`}
                            >
        ...
        <div className="mt-6">
            ...
            <div className="p-4 rounded surface-card shadow-sm">
...

                {
                    ...
                    <pre className="mt-6 bg-gray-100 p-3 rounded overflow-auto">
