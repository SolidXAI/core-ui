        ...
        <form style={{ width: '100%', background: "#fff" }} onSubmit={formik.handleSubmit}>
          ...
          <div className="solid-form-content">
            ...
            <SolidPanel header={"Basic Info"} className="solid-column-panel">
              <div className="flex flex-wrap -mx-2 -mt-2 mt-4">
                <div className="field w-full lg:w-1/2 px-2 pt-2 pb-4 lg:pb-0">
                ...
                <div className="field w-full lg:w-1/2 px-2 pt-2">
                  <div className={styles.fieldWrapper}>
              ...
              <div className="flex flex-wrap -mx-2 -mt-2 mt-6">
                <div className="field w-full lg:w-1/2 px-2 pt-2 pb-4 ld:pb-0">
                  <div className={styles.fieldWrapper}>
