...
const KanbanCard: React.FC<KanbanCardProps> = ({ data, solidKanbanViewMetaData, index, isDragDisabled = false, setLightboxUrls, setOpenLightbox, editButtonUrl, recordClickViewMode = "edit", groupByFieldName, group, cardNode, DynamicCardWidget, onDelete, onRecover, showArchived }) => {
  ...
  const openRecord = () => {
    ...
    persistReturnView();
    router.push(`${editButtonUrl}/${data?.id}?viewMode=${recordClickViewMode}`);
  };
