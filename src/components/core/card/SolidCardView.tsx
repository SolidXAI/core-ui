          ...
          <div className="solid-card-view-content">
            ...
            {totalRecords > 0 && (
              <div className="solid-card-view-pagination">
                <div className="solid-card-view-pagination-bar solid-table-paginator flex items-center justify-center gap-4 text-sm rounded-md border border-border/60 px-4 py-1.5 bg-background">
