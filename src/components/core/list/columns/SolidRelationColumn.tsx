...
const SolidRelationColumn = ({ solidListViewMetaData, fieldMetadata, column, embeded, disabled }: SolidListViewColumnParams) => {
    if (fieldMetadata.relationType === 'many-to-one') {
        return SolidRelationManyToOneColumn({ solidListViewMetaData, fieldMetadata, column, embeded, disabled });
    }
