...
export const UserListView = () => {
  ...
  return (
    <div className="solid-user-list w-full">
      ...
      <div className="flex flex-wrap -mx-2 -mt-2 mb-4">
        {[
          ...
          <div className="field w-full md:w-1/4 px-2 pt-2" key={filter.key}>
            <SolidInput
        ...
        <div className="field w-full px-2 pt-2 flex items-center gap-2">
