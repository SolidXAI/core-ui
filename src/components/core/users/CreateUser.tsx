      ...
      <div className="solid-user-details-stack">
        <SolidPanel header="Basic Info" className="solid-column-panel">
          <div className="flex flex-wrap">
            ...
            <div className="field w-full md:w-1/2 flex flex-col gap-2 mt-4">
        ...
        <SolidPanel toggleable header="Access" className="solid-column-panel">
          <div className="flex flex-wrap solid-user-access-grid">
            {isEditMode ? (
              <div className="field w-full solid-user-access-row">
