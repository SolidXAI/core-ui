        ...
        <>
            ...
            <div className={`${styles.SolidChartCardWrapper} p-4`}>
                ...
                <div className='mt-3'>
                    ...
                    {question.visualisedAs === 'prime-meter-group' && <div className="card flex justify-content-center"><MeterGroup values={questionData.data.visualizationData.dataset} /></div>}
