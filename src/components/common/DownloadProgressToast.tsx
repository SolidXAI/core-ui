  ...
  return (
    <div
      style={{
        ...
        right: "1rem",
        padding: "1rem",
        backgroundColor: "var(--primary-light-color)", // Tailwind gray-800
        color: "white",
        borderRadius: "6px",
    ...
    >
     <div className="flex align-items-center justify-content-between gap-3">
        ...
        <div className="flex-1">
          <h2 className={`text-lg font-semibold m-0 ${status === "error" ? "text-red-500" : ""}`}>
            {message}
          </h2>
      ...
      {status !== "error" && (
        <ProgressBar value={progress} className="mt-3 custom-progress" />
      )}
    </div>
  );
};
