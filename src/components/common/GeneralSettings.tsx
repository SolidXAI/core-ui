              ...
              {pathname.includes("app-settings") && (
                <>
                  <div className="flex flex-wrap">
                    <div className="w-full lg:w-[83.333333%] xl:w-2/3">
                      <div className="flex flex-wrap">
                      ...
                      <div className="flex flex-wrap">
                        <div className="w-full md:w-1/2">
                          <div className="flex flex-wrap items-center">
                            <div className="w-[83.333333%] sm:w-3/4 lg:w-[41.666667%] pb-2 md:pb-0">
                                                            <label className="form-field-label">Show Details on Authentication Screen</label>
                            </div>
                            <div className="w-1/6 sm:w-1/4 lg:w-[58.333333%]">
                              <SolidSwitch
                        ...
                        <div className="w-full md:w-1/2">
                          <div className="flex flex-wrap items-center">
                            <div className="w-full md:w-[41.666667%] pb-2 md:pb-0">
                  ...
                  <div className='flex flex-wrap'>
                    <div className='w-full lg:w-[83.333333%] xl:w-2/3'>
                      <div className="flex flex-wrap">
                        <div className="w-full md:w-1/2">
                          <div className="flex flex-wrap items-center">
                            <div className="w-[83.333333%] sm:w-3/4 lg:w-[41.666667%]">
                        ...
                        <div className="w-full md:w-1/2">
                          <div className="flex flex-wrap items-center">
                            <div className="w-full md:w-[41.666667%] py-2 md:py-0">
                              <label className="form-field-label">
                  ...
                  <div className="flex flex-wrap">
                    <div className="w-full lg:w-[83.333333%] xl:w-2/3">
                      <div className="flex flex-wrap">
                        <div className="w-full md:w-1/2">
                          <div className="flex flex-wrap items-center">
                            <div className="w-[83.333333%] sm:w-[83.333333%] lg:w-[41.666667%]">
                              <label className="form-field-label">
                                Enable Dark Mode
                              </label>
                            </div>
                    ...
                    <div className="w-full lg:w-[83.333333%] xl:w-2/3">
                      <div className="flex flex-wrap">
                        ...
                        {formik.values.passwordLessAuth === true && (
                          <div className="w-full mt-4">
                            <div className="flex flex-wrap items-center">
                              <div className="w-full sm:w-full lg:w-[41.666667%] xl:w-[41.666667%]">
                                <label className="form-field-label">
                                    ...
                                    <div className='flex flex-wrap'>
                                        <div className='w-full lg:w-[83.333333%] xl:w-2/3'>
                                            <div className="flex flex-wrap">
                                                ...
                                                <div className="w-full md:w-[41.666667%] pb-2">
                                                    <div className="flex flex-wrap items-center">
                                                        <div className="w-[83.333333%] sm:w-3/4 lg:w-[41.666667%]">
