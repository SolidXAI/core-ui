...
export const GeneralSettings = () => {
    ...
    const onAppLogoDrop = useCallback(
      ...
      try {
        const parsed = typeof raw === "string" ? JSON.parse(raw) : raw;
        return (
          parsed && typeof parsed === "object" ? parsed : defaultAiConfig
        ) as SolidAiConfig;
      } catch {
        return defaultAiConfig;
      }
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      try {
        const updatedSettingsArray: Array<{
          key: string;
          value: string;
          type: string;
        }> = [];
          ...
          <form onSubmit={formik.handleSubmit}>
            ...
            <div className="px-4 py-3 md:p-4 solid-form-content">
                          ...
                          {formik.values.authPagesLayout === "center" && (
                            <div>
                              ...
                              {formik.values
                                ...
                                <SettingsImageRemoveButton
                                  onClick={
                                    removeAuthScreenCenterBackgroundImage
                                  }
                                />
                              )}
                            </div>
                      ...
                      <div className="formgrid grid">
                        <div className="col-12 lg:col-10 xl:col-8">
                          <SolidSegmentedControl
                            ...
                            onChange={(value) =>
                              formik.setFieldValue("authPagesTheme", value)
                            }
                          />
                        </div>
                      </div>
              ...
              {pathname.includes("ai-settings") && (
                <AiSettingsSection
                  aiConfig={
                    formik.values.solidXGenAiCodeBuilderConfig as SolidAiConfig
                  }
                  onAiConfigChange={handleAiConfigChange}
                />
              )}
