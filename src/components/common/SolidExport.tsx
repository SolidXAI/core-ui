...
export const SolidExport = ({ listViewMetaData, filters }: any) => {
  ...
  const renderSourceItem = (item: Question) => (
          <div key={item.key} className="solidCustomPicklistItemWrapper solidCustomPicklistSourceItem">
              <div className="flex items-center gap-2">
                  ...
                  <label htmlFor={item.key} className="solidCustomPicklistItemContent ml-2">
                      {item.name}
                  </label>
              </div>
          </div>
  ...
  const renderTargetItem = (item: Question) => (
          <div key={item.key} className="solidCustomPicklistItemWrapper gap-2">
              ...
              <span className="solidCustomPicklistItemContent flex-1">{item.name}</span>
  ...
  const renderEmptyRow = (index: number) => (
    ...
    const itemTemplate = (option: TemplateOption) => {
      return (
        <div className="ExportItemWrapper">
  ...
  return (
    <>
      ...
      { currentStepValue === 'export' && 
            <>
            <div className="solidExportControls gap-2">
            ...
            <div className="solidCustomPicklist mt-2">
                        <div className="flex">
                            {/* All Questions */}
                            <div className="w-6">
                                <div className="solidCustomPicklistHeader solidCustomPicklistSourceHeader">Available Fields</div>
                                <div>
                            ...
                            {/* Selected Questions */}
                            <div className="w-6">
                                <div className="solidCustomPicklistHeader" >Selected Fields</div>
                                <div>
