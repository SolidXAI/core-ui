...
export const SolidExport = ({ listViewMetaData, filters }: any) => {
  ...
  const renderSourceItem = (item: Question) => (
          <div key={item.key} className={`${styles.solidCustomPicklistItemWrapper} ${styles.solidCustomPicklistSourceItem}`}>
              <div className="flex items-center gap-2">
                  ...
                  <label htmlFor={item.key} className={`${styles.solidCustomPicklistItemContent} ml-2`}>
                      {item.name}
                  </label>
              </div>
          </div>
  ...
  const renderTargetItem = (item: Question) => (
          <div key={item.key} className={`${styles.solidCustomPicklistItemWrapper} gap-2`}>
              ...
              <span className={`${styles.solidCustomPicklistItemContent} flex-1`}>{item.name}</span>
  ...
  const renderEmptyRow = (index: number) => (
    <div key={`empty-${index}`} className={styles.solidCustomPicklistItemWrapper}/>
  );
  ...
  return (
    <>
      ...
      { currentStepValue === 'export' && 
            ...
            <div className={`${styles.solidCustomPicklist} mt-2`}>
                        <div className="flex">
                            {/* All Questions */}
                            <div className="w-6">
                                <div className={`${styles.solidCustomPicklistHeader} ${styles.solidCustomPicklistSourceHeader}`}>Available Fields</div>
                                <div>
                            ...
                            {/* Selected Questions */}
                            <div className="w-6">
                                <div className={styles.solidCustomPicklistHeader} >Selected Fields</div>
                                <div>
